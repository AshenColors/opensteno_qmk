...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [STENO] = LAYOUT(STN_RES1, STN_N1, STN_N2, STN_N3, STN_N4, STN_N5, STN_N6, STN_N7, STN_N8, STN_N9, STN_NA, STN_FN,
      MO(MODE), STN_S1, STN_TL, STN_PL, STN_HL, STN_ST1, STN_ST3, STN_FR, STN_PR, STN_LR, STN_TR, STN_DR,
      MO(LOWER), STN_S2, STN_KL, STN_WL, STN_RL, STN_ST2, STN_ST4, STN_RR, STN_BR, STN_GR, STN_SR, STN_ZR,
    ...
    [QWERTY] = LAYOUT(KC_DEL, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
      ...
      LT(LOWER, KC_ENT), XXXXXXX, TO(STENO), MO(MODE), XXXXXXX, LT(RAISE, KC_SPC)),
    ...
    [LOWER] = LAYOUT(_______, KC_AT, KC_LABK, KC_DLR, KC_RABK, XXXXXXX, XXXXXXX, KC_LBRC, KC_ASTR, KC_RBRC, KC_GRV, _______,
      _______, KC_BSLASH, KC_LPRN, KC_MINUS, KC_RPRN, KC_HASH, KC_PERC, KC_LCBR, KC_EQUAL, KC_RCBR, KC_COLN, XXXXXXX,
      _______, KC_PIPE, KC_EXLM, KC_UNDS, KC_PLUS, XXXXXXX, XXXXXXX, KC_AMPR, KC_CIRC, KC_TILDE, KC_QUES, XXXXXXX,
      _______, _______, _______, _______, _______, _______),

    [MODE] = LAYOUT(TG(QWERTY), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      TG(NKRO), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______)};
