...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LOWER] = LAYOUT(
        _______, KC_AT,     KC_LABK, KC_DLR,   KC_RABK, XXXXXXX,                     XXXXXXX, KC_LBRC, KC_ASTR,  KC_RBRC,  KC_GRV,  _______,
  ...
  [MODE] = LAYOUT(
    TG(QWERTY), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
